...
def test_prompt_gen_task_with_mocked_dependencies():
    ...
    try:
        ...
        with (
            patch("obh.generate.setup_llm_client"),
            patch(
                "obh.generate.rate_limited_call",
                return_value={"prompt": "test prompt", "objects": ["test"]},
            ),
            patch(
                "obh.generate.validate_and_clean_prompt_gen_response",
                return_value={"prompt": "test prompt", "objects": ["test"]},
            ),
            patch(
                "obh.generate.restructure_objects",
                return_value={"prompt": "test prompt", "objects": ["test"]},
            ),
